...
{
    public class ShipSelectorCarouselManager : MonoBehaviour
    {
        public GameObject containerCarousel;
        public ShipSelectorManager shipSelectorManager;
        ...
        void PlotShipsIntoCarousel(GameObject[] ships, bool displayPriceTag)
        {
            ...
            for (int i = 0; i < ships.Length; i++)
            {
                ...
                if (!displayPriceTag)
                {
                    shipInstance.transform.Find("PriceTag").gameObject.SetActive(false);
                    shipInstance.transform.Find("Coin").gameObject.SetActive(false);
                }
                ...
                shipInstance.transform.Find("ShipButton").GetComponent<Button>().onClick.AddListener(() => shipSelectorManager.SetSelectedObject(ShopSelectedObjectEnum.Ship, shipInstance, shipInstance.GetComponent<Ship>().GetName()));
            }
        }
        ...
        {
            Transform shipTransform = shipButtonParent.transform.Find("ShipButton");
